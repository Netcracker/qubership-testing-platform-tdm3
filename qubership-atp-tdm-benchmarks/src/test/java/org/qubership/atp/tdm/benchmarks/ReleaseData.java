...
public class ReleaseData extends AbstractTestDataTest implements AbstractJmhTest {
    ...
    public void runBenchmarksToReleaseData() throws Exception {
        setFields();
        Options opts = prepareOptionBuilder("jmh-release-data-report.json");
        new Runner(opts).run();
    }
    ...
    public static class Data {
        ...
        public void setUp() {
            ...
            testingTarget.createTestDataTable(RELEASE_TEST_DATA);
            testingTarget.occupyTestData(RELEASE_TEST_DATA);
        }
    }
}
