...
| `GIT_URL` | `string` | `yes` | `""` | Git repository base URL (e.g., https://git.netcracker.com). |
...
| `FROM_EMAIL_ADDRESS` | `string` | `no` | `"ATP-TDM-Tool@NetCracker.com"` | Sender email address for notifications. |
