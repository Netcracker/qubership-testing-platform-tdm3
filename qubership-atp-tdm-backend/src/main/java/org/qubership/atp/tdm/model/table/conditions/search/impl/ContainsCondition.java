...
public class ContainsCondition extends AbstractCondition implements SearchCondition {

    private boolean isCaseSensitive;

    public ContainsCondition(boolean isCaseSensitive) {
        this.isCaseSensitive = isCaseSensitive;
    }

    @Override
    public BinaryCondition create(CustomSql customSql, String value) {
        return super.create(customSql, "%" + value + "%", isCaseSensitive);
    }
}
