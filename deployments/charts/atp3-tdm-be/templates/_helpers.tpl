...
EXTERNAL_QUERY_DEFAULT_TIMEOUT: "{{ .Values.atp3tdm.externalQueryDefaultTimeout }}"
EXTERNAL_QUERY_MAX_TIMEOUT: "{{ .Values.atp3tdm.externalQueryMaxTimeout }}"
...
PROJECT_INFO_ENDPOINT: "{{ .Values.atp3tdm.projectInfoEndpoint }}"
